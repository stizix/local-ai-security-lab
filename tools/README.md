...
| `chromadb_audit.py` | Audit a ChromaDB instance for unauthenticated access — auth posture, collection enumeration, document dump; `--prove-write` for a self-cleaning write canary | Shipped — see [finding 003](../findings/003-chromadb-unauth) |

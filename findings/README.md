...
| [005](005-cross-model-extraction/) | System-prompt extraction across 6 local models — same secret, same prefix-injection attack; leak rate ranges 10/10 (uncensored) to 2/10 (well-aligned). Alignment quality, not size, predicts exposure | 6 local Ollama models | mistral-base, dolphin-llama3, llama3.2:3b, deepseek-r1:8b, llama3.1:8b, qwen2.5:3b |

Next expected Week 7 (stored / persistent RAG poisoning in a real vector store).
